                        ...
                        \yiister\gentelella\widgets\Menu::widget(
                            [
                                "items" => [
                                    ...
                                    ["label" => "Sapi Anda", "url" => ["/datasapi/index"], "icon" => "list-alt"],
                                    ...
                                    [
                                        ...
                                        "url" => "#",
                                        "items" => [
                                            ["label" => "Kondisi Visual", "url" => ["site/menu"],"icon" => "eye"],
                                            ["label" => "BCS", "url" => ["site/panel"],"icon" => "hdd"],
                                            ["label" => "Riwayat Kesehatan", "url" => ["site/menu"],"icon" => "plus",],
                                            ["label" => "Riwayat Vaksinasi", "url" => ["site/panel"],"icon" => "pencil"],
                                        ],
                                    ],
                                    // [
                                    //     "label" => "Badges",
