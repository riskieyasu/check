...
<div class="bcs-create" style="background-color:white; width:75%; margin-left:100px; border-style: solid; border-color:black;">
    <br><h3 style="margin-bottom:-10px; margin-left:70px;color:black;">Bantuan</h3><hr><br><img style="margin-left:100px" id ="img" src="/../bcs.jpg" alt="Girl in a jacket" width="600" height="200">
</div>
<br><br>
<div class="bcs-create" style="background-color:white; width:75%; margin-left:100px; border-style: solid; border-color:black;">
