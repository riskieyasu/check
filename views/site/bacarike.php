...
<div class="jumbotron text-center" style="margin-top:10px;">
        <h1 style="font-size:40px;">Kumpulan Artikel Riwayat Kesehatan</h1>
    <br>
...
$rows=$query->select(['id','judul','isi','foto']) //specify required columns in an array
             ...
             ->where(['kategori' => 'Riwayat Kesehatan'])
             ->all(); 
             ...
             echo "<img src='../web/uploads/Riwayat Kesehatan-$cek.jpg' alt='Italian Trulli' width='440' height='230'>';";
