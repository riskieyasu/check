...
<div class="jumbotron text-center" style="margin-top:10px;">
        <h1 style="font-size:40px;">Kumpulan Artikel Kondisi Visual</h1>
    <br>
...
$rows=$query->select(['id','judul','isi','foto']) //specify required columns in an array
             ...
             if($row['foto'] != '') {
             echo "<img src='../web/uploads/Kondisi Visual-$cek.jpg' id='gambar' alt='Italian Trulli'  width='440' height='230'>';";
             }
