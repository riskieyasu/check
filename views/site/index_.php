...
<div class="jumbotron text-center" style="margin-top:10px;">
        <h1 id ="h1" style="font-size:40px;">Selamat Datang Di Mata Sapi, <?php if(!Yii::$app->user->isGuest){echo Yii::$app->user->identity->username;} ?>!</h1>
        <p id ="iduser" style="display:none"><?php if(!Yii::$app->user->isGuest){echo Yii::$app->user->identity->id;} ?></p>
    <br>
