...
class BcsController extends Controller
{
    ...
    {   $num = 0;
        $numa =0;
        $a='z';
        $content = "<h1 id='cek' style='text-align:center; margin-top:20px; color:black;'>Data kesehatan sapi anda</h1><div class='flex-container' style='height:70%; overflow-y: scroll;'><br><table class='table' style='margin-bottom:312px;  margin-left:350px;width:450px;'><tr>
        <th>No</th>
        <th>View (ID)</th>
        <th>status</th>
